...
interface FunctionNodeProps {
  ...
  saveImageTag: string;
  setSaveImageTag: Dispatch<SetStateAction<string>>;
  saveImageName: string;
  setSaveImageName: Dispatch<SetStateAction<string>>;
...
const FunctionNodeComponent: React.FC<FunctionNodeProps> = ({
  ...
  const [showConfirmDeleteImage, setShowConfirmDeleteImage] = useState<
    string | null
  >(null);
  ...
  const confirmDeleteImage = () => {
    if (showConfirmDeleteImage) {
      ...
      setShowConfirmDeleteImage(null); // 关闭对话框
    }
  };
            ...
            <div className="flex-1">
              <div className="flex items-center justify-center gap-1">
                <select
                  ...
                  className="w-full px-2 py-1 border-2 border-gray-200 rounded-xl
                focus:outline-none focus:ring-2 focus:ring-indigo-500
